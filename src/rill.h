...
size_t dbg_rill_store_data_off(const struct rill_store *store, enum rill_col column);
size_t dbg_rill_store_index_off(const struct rill_store *store, enum rill_col column);
